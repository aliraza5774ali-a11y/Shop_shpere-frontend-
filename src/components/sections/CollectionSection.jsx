  ...
  return (
    <section className="bg-[#f8f8f8] px-28 pt-10 pb-18 flex flex-col gap-10">
      ...
      <SectionHeader
        ...
        heading={<>Modern collections <br /> defined by simplicity</>}
      ...
      <CollectionCard images={IMAGES2} wearType="Women's Wear"    wearBadge="New"  title1="Modern daily"   title2="wear for women"          priceFrom="$35.00" priceTo="$150.00" reverse="true" />
